...
lsof / \| awk \'\' \| sort -n -u \| tail

 

显示剩余内存(MB):

free -m \| grep cache \| awk \'/\[0-9\]/\'
...
curl -sL -w \"%\\\\n\" [www.example.com](http://www.example.com) -o /dev/null
...
之前这个问题困扰了很久，可能因为空格的问题，调用shell脚本进行cp或者mv不成功，

如下部分代码可供将带空格的文件名转化为下划线。
...
SAP HANA Customer Support Process   <https://www.dell.com/support/kbdoc/en-au/000187272>

 like 1

Login or Register \| Dell US

 

\[16:49\] Luo, Jeason

CCC Enterprise SAP HANA产品支持流程\-\--000131899https://dellservices.lightning.force.com/lightning/r/Lightning_Knowledge\_\_kav/ka06P0000004O4TQAU/view
