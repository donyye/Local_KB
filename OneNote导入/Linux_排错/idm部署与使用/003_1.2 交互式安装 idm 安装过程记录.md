...
[Do you want to configure integrated DNS (BIND)? \[no\]: yes] [ \#]集成DNS选择yes不集成选no
...
[Server host name \[master.idm.domain.com\]: ]
...
[Please confirm the domain name \[idm.domain.com\]: ]
...
[Please provide a realm name \[IDM.DOMAIN.COM\]: ]
...
Directory Manager password: [ xxxxxxxxxxx]

Password (confirm): [ xxxxxxxxxxx]
...
IPA admin password: [ xxxxxxxxxxx]
...
DNS check for domain idm.domain.com. failed: The DNS operation timed out after 24.21327567100525 seconds.
