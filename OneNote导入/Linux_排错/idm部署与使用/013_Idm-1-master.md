...
[\[root@xm-idm1 \~\]#] cat /etc/redhat-release

Red Hat Enterprise Linux release 9.1 (Plow)

 

[\[root@xm-idm1 \~\]#] uname -a

Linux xm-idm1.idm.si-en.com 5.14.0-162.6.1.el9_1.x86_64 #1 SMP PREEMPT_DYNAMIC Fri Sep 30 07:36:03 EDT 2022 x86_64 x86_64 x86_64 GNU/Linux

 

 

[\[root@xm-idm1 \~\]#] ip add \|egrep \'ens192\|ens224\'

2: ens192: \<BROADCAST,MULTICAST,UP,LOWER_UP\> mtu 1500 qdisc mq state UP group default qlen 1000

    inet 10.10.40.11/16 brd 10.10.255.255 scope global noprefixroute ens192

3: ens224: \<BROADCAST,MULTICAST,UP,LOWER_UP\> mtu 1500 qdisc mq state UP group default qlen 1000

    inet 10.10.140.11/16 brd 10.10.255.255 scope global noprefixroute ens224

 

[\[root@xm-idm1 \~\]#] cat /etc/hosts
...
[\[root@xm-idm1 \~\]#] cat /etc/resolv.conf
...
安装idm软件包：\
[\[root@xm-idm1 \~\]]\# dnf install ipa-server ipa-server-trust-ad samba-client ipa-server-dns -y

 

开始安装idm:

[\[root@xm-idm1 \~\]#] ipa-server-install \--realm idm.si-en.com \--ds-password P@ssw0rd! \--admin-password P@ssw0rd! \--unattended \--setup-dns \--no-forwarder \--auto-reverse
...
Warning: skipping DNS resolution of host xm-idm1.idm.si-en.com

The domain name has been determined based on the host name.

 

Checking DNS domain idm.si-en.com., please wait \...

DNS check for domain idm.si-en.com. failed: The DNS operation timed out after 24.212658882141113 seconds.

Checking DNS domain 140.10.10.in-addr.arpa., please wait \...

Reverse zone 140.10.10.in-addr.arpa. for IP address 10.10.140.11 already exists
...
Hostname:       xm-idm1.idm.si-en.com

IP address(es): 10.10.140.11
...
Subject DN:   CN=Certificate Authority,O=IDM.SI-EN.COM

Subject base: O=IDM.SI-EN.COM
...
Create database backend: dc=idm,dc=si-en,dc=com \...
...
Client hostname: xm-idm1.idm.si-en.com

Realm: IDM.SI-EN.COM

DNS Domain: idm.si-en.com

IPA Server: xm-idm1.idm.si-en.com

BaseDN: dc=idm,dc=si-en,dc=com
...
Configuring idm.si-en.com as NIS domain.
...
<https://access.redhat.com/documentation/zh-cn/red_hat_enterprise_linux/8/html-single/installing_identity_management/index#installing-ipa-server-with-dns-interactive-install_install-server-with-dns>
