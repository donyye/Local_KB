...
英特尔® Data Streaming Accelerator（[英特尔®](https://zhida.zhihu.com/search?content_id=232279453&content_type=Article&match_order=2&q=%E8%8B%B1%E7%89%B9%E5%B0%94%C2%AE&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3NDIzNDkwNzYsInEiOiLoi7HnibnlsJTCriIsInpoaWRhX3NvdXJjZSI6ImVudGl0eSIsImNvbnRlbnRfaWQiOjIzMjI3OTQ1MywiY29udGVudF90eXBlIjoiQXJ0aWNsZSIsIm1hdGNoX29yZGVyIjoyLCJ6ZF90b2tlbiI6bnVsbH0.nsBgz0B4R5cWcuUn2l4YJ-K1BS5vaQap-KIazd6Llsw&zhida_source=entity) DSA）和英特尔® In-Memory Analytics Accelerator（英特尔® IAA）是集成在英特尔第四代至强可扩展平台中的两个重要加速器。

DSA 旨在优化高性能存储、网络、持久内存和各种数据处理应用常见的[流数据](https://zhida.zhihu.com/search?content_id=232279453&content_type=Article&match_order=1&q=%E6%B5%81%E6%95%B0%E6%8D%AE&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3NDIzNDkwNzYsInEiOiLmtYHmlbDmja4iLCJ6aGlkYV9zb3VyY2UiOiJlbnRpdHkiLCJjb250ZW50X2lkIjoyMzIyNzk0NTMsImNvbnRlbnRfdHlwZSI6IkFydGljbGUiLCJtYXRjaF9vcmRlciI6MSwiemRfdG9rZW4iOm51bGx9.V5kTLR0kTafvKOgozoWVqDz_fughdp-mYFDE1WQUyMg&zhida_source=entity)移动和转换操作。它有两种模式，共享模式(share)和专用模式(dedicated）。

IAA 可以提供高性能的压缩和解压能力，结合其[数据分析](https://zhida.zhihu.com/search?content_id=232279453&content_type=Article&match_order=1&q=%E6%95%B0%E6%8D%AE%E5%88%86%E6%9E%90&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3NDIzNDkwNzYsInEiOiLmlbDmja7liIbmnpAiLCJ6aGlkYV9zb3VyY2UiOiJlbnRpdHkiLCJjb250ZW50X2lkIjoyMzIyNzk0NTMsImNvbnRlbnRfdHlwZSI6IkFydGljbGUiLCJtYXRjaF9vcmRlciI6MSwiemRfdG9rZW4iOm51bGx9.NPnuRFKZhK_4_NfUpsnVK9cAoPPnceSmOaSSiNn1qC0&zhida_source=entity)功能，有助于更快地运行数据库和分析工作负载。

下面有个视频主要介绍 DSA 和 IAA 在 Linux 内核中的典型应用场景并分析它们带来的性能收益。 \<[https://zhuanlan.zhihu.com/p/648672387](https://zhuanlan.zhihu.com/p/648672387)\> 
...
如果使能CONFIG_INTEL_IOMMU_DEFAULT_ON或者CONFIG_INTEL_IOMMU_SCALABLE_MODE_DEFAULT_ON 选项，则必须在内核启动参数中添加 intel_iommu=on,sm_on。
...
上面lspci的输出中可以看到最后三个Capabilities： ATSCtrl, PASIDCtl和PRICtl 三项已经启用。
...
可以看到驱动程序创建了4个dsa 设备文件dsa，4个iax设备文件iax。同时还有每个设备上的8个workqueue，4个engine和4个group。
...
![[__Ubuntu___012__—什么是IAA与DSA_001.png]]
...
![[__Ubuntu___012__—什么是IAA与DSA_002.png]]
...
![[__Ubuntu___012__—什么是IAA与DSA_003.png]]
...
![[__Ubuntu___012__—什么是IAA与DSA_004.png]]
...
![[__Ubuntu___012__—什么是IAA与DSA_005.png]]
